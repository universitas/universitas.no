    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(editable=False, verbose_name='created', default=django.utils.timezone.now)),
                ('modified', model_utils.fields.AutoLastModifiedField(editable=False, verbose_name='modified', default=django.utils.timezone.now)),
                ('height', models.PositiveSmallIntegerField(validators=[myapps.frontpage.models.FrontPageModule.validate_height], help_text='height - minimum 1 maximum 3', default=1)),
                ('columns', models.PositiveSmallIntegerField(validators=[myapps.frontpage.models.FrontPageModule.validate_columns], help_text='width - minimum 1 maximum 12', default=6)),
