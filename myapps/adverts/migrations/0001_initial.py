    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateTimeField(default=myapps.adverts.models.default_start_time, help_text='When to start serving this ad')),
                ('end_time', models.DateTimeField(default=myapps.adverts.models.default_end_time, help_text='When to stop serving this ad')),
                ('imagefile', sorl.thumbnail.fields.ImageField(upload_to=myapps.adverts.models.upload_folder, help_text='Image Ad: image file in jpg or png format', null=True, blank=True)),
