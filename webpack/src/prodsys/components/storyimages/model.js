...
export const fields = {
  ...
  aspect_ratio: {
    ...
    options: [
      { value: '0.0000', label: 'auto' },
      { value: '0.4000', label: '5:2 bredde' },
      { value: '0.5000', label: '2:1 bredde' },
      { value: '0.5625', label: '16:9 bredde (youtube)' },
      { value: '0.6667', label: '3:2 bredde' },
      { value: '0.7500', label: '4:3 bredde' },
      { value: '1.0000', label: '1:1 kvadrat' },
      { value: '1.3333', label: '3:4 høyde' },
      { value: '1.5000', label: '2:3 høyde' },
      { value: '2.0000', label: '1:2 høyde' },
    ],
  },
}
