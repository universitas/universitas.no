    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timing', models.PositiveSmallIntegerField(default=1, choices=[
                 (1, 'import'), (2, 'extra'), (3, 'bylines'), (4, 'clean')])),
                ('ordering', models.PositiveSmallIntegerField(default=1)),
                ('comment', models.CharField(max_length=1000,
                                             default='explain this pattern', blank=True)),
            ],
            options={
                'verbose_name': 'Alias',
                'ordering': ('ordering',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_tag', models.CharField(
                    max_length=50, unique=True, default='', blank=True)),
                ('html_tag', models.CharField(max_length=50, default='', blank=True)),
                ('html_class', models.CharField(
                    max_length=50, default='', blank=True)),
                ('action', models.CharField(max_length=200, default='append:', choices=[('append:', 'add'), ('alias', 'alias'), ('append:bodytext', 'body text'), ('append:title', 'title'), ('append:kicker', 'kicker'), (
                    'append:lede', 'lede'), ('append:theme_word', 'theme word'), ('new:byline', 'byline'), ('new:aside', 'create aside'), ('new:pullquote', 'create pullquote'), ('drop:', 'delete')])),
            ],
            options={
