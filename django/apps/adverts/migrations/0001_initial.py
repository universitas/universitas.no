    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'price',
                    models.PositiveIntegerField(help_text='display price')
                ),
            ...
            fields=[
                ...
                (
                    'ad_type', models.PositiveIntegerField(
                        ...
                        editable=False,
                        choices=[(1, 'Image advert'), (2, 'HTML advert'),
                                 (3, 'Dummy or unfinished advert')]
                    )
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                help_text='size and shape of ad',
                null=True,
                to='adverts.AdFormat'
            ),
            preserve_default=True,
