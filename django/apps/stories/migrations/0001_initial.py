    ...
    operations = [
            ...
            fields=[
                ...
                (
                    'credit', models.CharField(
                        max_length=20,
                        default='text',
                        choices=[('text', 'Text'), ('photo', 'Photo'),
                                 ('video', 'Video'), ('illus', 'Illustration'),
                                 ('graph', 'Graphics'),
                                 ('trans', 'Translation'), ('???', 'Unknown')]
                    )
                ),
                (
                    'title',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'title', apps.stories.models.MarkupCharField(
                        verbose_name='title',
                        max_length=1000,
                        default='',
                ...
                (
                    'kicker', apps.stories.models.MarkupCharField(
                        verbose_name='kicker',
                        max_length=1000,
                        default='',
                        help_text=
                ...
                (
                    'lede', apps.stories.models.MarkupTextField(
                        verbose_name='lede',
                        default='',
                ...
                (
                    'theme_word', apps.stories.models.MarkupCharField(
                ...
                (
                    'publication_status', models.IntegerField(
                        ...
                        choices=[(0, 'Draft'), (5, 'Ready to edit'),
                                 (9, 'Ready to publish on website'),
        ...
        migrations.CreateModel(
            ...
            bases=(
                'stories.storyelement', models.Model,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'caption', apps.stories.models.MarkupCharField(
                ...
                (
                    'creditline', apps.stories.models.MarkupCharField(
            ...
            bases=(
                'stories.storyelement', apps.stories.models.MarkupModelMixin
            ),
        ),
        migrations.CreateModel(
            name='StoryType',
            fields=[
                ...
                (
                    'section', models.ForeignKey(
                        on_delete=models.CASCADE, to='stories.Section'
                    )
                ),
                (
